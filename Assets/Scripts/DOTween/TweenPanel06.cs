...
public class TweenPanel06 : TweenPanel
{
    ...
    public override void StartTween()
    {
        ...
        .AppendInterval(0.1f)
        .Append(text01.DOText("* WA!!! 샌즈!!!!", 0.4f))
        .AppendInterval(0.1f)
        .Append(text02.DOText("* 언더테일 아시는구나! 혹시 모르시는분들에 대해 설명해드립니다 샌즈랑 언더테일의 세가지 엔딩루트중 몰살엔딩의 최종보스로 진.짜.겁.나.어.렵.습.니.다 공격은 전부다 회피하고 만피가 92인데 샌즈의 공격은 1초당 60이 다는데다가 독뎀까지 추가로 붙어있습니다.", 8f))
        .Play();
    }
